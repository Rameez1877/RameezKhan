/****** Object:  View [dbo].[Keywordlist_linkedin_bing]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE view  [dbo].[Keywordlist_linkedin_bing]
as
...
from linkedinapi_bing a  , country b,appuser c,mcdecisionmaker mdm 
