/****** Object:  Procedure [dbo].[QA_ResetUserConfiguration]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[QA_ResetUserConfiguration] @UserId int
AS BEGIN
SET NOCOUNT ON;
