/****** Object:  Procedure [dbo].[SearchOrganization]    Committed by VersionSQL https://www.versionsql.com ******/

-- Script Date: 05-Jan-22 - Kabir
-- last edit: 24-Feb-2022
CREATE PROCEDURE [dbo].[SearchOrganization] 
	@UserId int,
...
AS BEGIN
/*
[dbo].[QA_SearchOrganization] 6121,'','','','','124,57'
*/
SET NOCOUNT ON;
