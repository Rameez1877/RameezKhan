/****** Object:  Procedure [dbo].[GetMarketingListFilterTemp]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetMarketingListFilterTemp]
@targetPersonaId int,
