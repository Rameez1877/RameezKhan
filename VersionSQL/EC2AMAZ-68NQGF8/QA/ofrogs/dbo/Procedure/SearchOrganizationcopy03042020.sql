/****** Object:  Procedure [dbo].[SearchOrganizationcopy03042020]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[SearchOrganizationcopy03042020] 
@UserId int = 0,
...
--
  ...
  --
	...
	or (@coe = '' or m.name in (SELECT [Data] FROM dbo.Split(@Coe, ','))))
