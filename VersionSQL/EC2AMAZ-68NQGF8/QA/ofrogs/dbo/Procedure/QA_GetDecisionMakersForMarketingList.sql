/****** Object:  Procedure [dbo].[QA_GetDecisionMakersForMarketingList]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[QA_GetDecisionMakersForMarketingList]
@UserID INT,
@MarketingListId INT,
@Page INT = 0,
@Size INT = 10,
