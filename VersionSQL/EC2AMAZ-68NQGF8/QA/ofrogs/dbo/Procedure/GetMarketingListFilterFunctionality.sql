/****** Object:  Procedure [dbo].[GetMarketingListFilterFunctionality]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetMarketingListFilterFunctionality] 
@TargetPersonaId int,
...
--   Select Top 10 Functionality, SUM(NoOfRecords) NoOfPersonLocation
...
--    )
--	 AND (@Functionality = ''
--   -- OR Functionality IN (SELECT [Data]FROM dbo.Split(@Functionality, ',')))
--	 AND (@Seniority = ''
