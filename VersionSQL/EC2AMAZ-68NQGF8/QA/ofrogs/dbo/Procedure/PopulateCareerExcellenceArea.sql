/****** Object:  Procedure [dbo].[PopulateCareerExcellenceArea]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================  
CREATE PROCEDURE PopulateCareerExcellenceArea
...
BEGIN
 ...
 -- DELETE FROM CareerExcellenceArea
 ...
 -- FROM Ofrogs.Dbo.McDecisionMaker t11,
 --      OrganizationWebsiteLinkContent A WITH (NOLOCK) 
 -- WHERE A.linktype='Career' -- add Organization Filter
 -- AND t11.IsOFList = 1
 -- AND ISactive = 1
