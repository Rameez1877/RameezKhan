/****** Object:  Procedure [dbo].[PopulateMarketingListFilterSummary]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[PopulateMarketingListFilterSummary] @TargetpersonaID int
AS
BEGIN 
  SET NOCOUNT ON;
  DECLARE @UserID Int
