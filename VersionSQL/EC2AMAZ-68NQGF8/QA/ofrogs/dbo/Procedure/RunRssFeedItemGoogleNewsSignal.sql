/****** Object:  Procedure [dbo].[RunRssFeedItemGoogleNewsSignal]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE Procedure [dbo].[RunRssFeedItemGoogleNewsSignal]
@RssFeedItemId int,
@industryid int,
@tagid int
