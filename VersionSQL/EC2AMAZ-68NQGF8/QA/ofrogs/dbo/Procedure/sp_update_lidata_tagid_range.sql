/****** Object:  Procedure [dbo].[sp_update_lidata_tagid_range]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].sp_update_lidata_tagid_range
@LiFromID int,
@LiToID int
AS
BEGIN
  ...
  AND id NOT IN (SELECT
    id
  FROM lidata_no_tag)
  AND Id Between @LiFromID AND @LiToID
