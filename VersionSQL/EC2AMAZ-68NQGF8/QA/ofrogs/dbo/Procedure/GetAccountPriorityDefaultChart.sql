/****** Object:  Procedure [dbo].[GetAccountPriorityDefaultChart]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetAccountPriorityDefaultChart]
...
from LeadScoreSubMarketingList LS
where  -- (@MarketingList = '' or LS.SubMarketingListName in (select [Data] from dbo.Split(@MarketingList, ',')))
