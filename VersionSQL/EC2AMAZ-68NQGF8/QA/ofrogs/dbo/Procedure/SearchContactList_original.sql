/****** Object:  Procedure [dbo].[SearchContactList_original]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[SearchContactList_original]
    @TargetPersonaId int,
...
SET @Seniority = @Seniority + 'C-Level,Director,Influencer'
    ...
    FROM LinkedInData li WITH (NOLOCK)
        ...
        ON (li.Id = ml.DecisionMakerId) and
