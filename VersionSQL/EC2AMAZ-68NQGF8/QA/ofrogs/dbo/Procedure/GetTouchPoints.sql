/****** Object:  Procedure [dbo].[GetTouchPoints]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE [dbo].[GetTouchPoints]  
...
BEGIN
	...
	WHERE	
			...
			--SELECT VALUE FROM string_split(@CountryFilterName,',')))
			 ...
			 EXEC GetTouchPointsSearchResult  @UserID, 0,10,''
			END
