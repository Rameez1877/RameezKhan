/****** Object:  Procedure [dbo].[QA_GetCustomPersonaData]    Committed by VersionSQL https://www.versionsql.com ******/
...
*/
CREATE PROCEDURE [dbo].[QA_GetCustomPersonaData] 
 @TargetPersonaId INT
,@CustomTeamPersonaID VARCHAR(200)
,@CustomTechnologyPersonaID VARCHAR(5000)	
...
ON AFTC.TechnologyCategoryId = SubCategoryID
WHERE IsActive =1)
