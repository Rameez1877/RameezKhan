/****** Object:  Procedure [dbo].[GetLeadScoreSettings_asef]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
Create PROCEDURE [dbo].[GetLeadScoreSettings_asef] 
	@UserId int = 1
AS
/*
...
BEGIN
	SET NOCOUNT ON;
	select 'Functionality' as [FilterType], 0 as Id,NULL AS CategoryName  ,SubMarketingListNameDisplay [Name], 0 as ApplyScore, 0 as IndustryGroupId
	from V_MarketingList
	union
	select 'Technology', 0 as Id,TSC.STACKTYPE as CategoryName , TST.StackTechnologyName Technology, 0 as ApplyScore,  0 as IndustryGroupId
	from  TechStackTechnology TST
		INNER JOIN TechStackSubCategory TSC
		ON TSC.ID = TST.STACKSUBCATEGORYID
	union
	select 'Industry', i.Id as Id,I.IndustryGroup AS CategoryName, I.[Name] COLLATE SQL_Latin1_General_CP1_CI_AS, 0 as ApplyScore, I.IndustryGroupId 
	from 
		Industry i		
