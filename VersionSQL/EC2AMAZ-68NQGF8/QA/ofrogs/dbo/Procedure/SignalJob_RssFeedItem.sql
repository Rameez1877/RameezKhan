/****** Object:  Procedure [dbo].[SignalJob_RssFeedItem]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[SignalJob_RssFeedItem]
@RssFeedItemId int
...
--Each Signal has its own keyword predefined. For ex: M&A signal can have a keyword 'acquires'
	...
	and I.industryID in (select industryid from rssfeeditemindustry where rssfeeditemid = @RssFeedItemId)
