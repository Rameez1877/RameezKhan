/****** Object:  Procedure [dbo].[PopulateSurgeDashboardPerUserID]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE [dbo].[PopulateSurgeDashboardPerUserID] @UserID int
AS
BEGIN
  ...
  CREATE TABLE #TempSurgeSummary (
	...
	SpendEstimate varchar(100),
	TechSpentEstimate int
  )
