/****** Object:  Procedure [dbo].[QA_GetLeadScoreSummary]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[QA_GetLeadScoreSummary] @TargetPersonaId int, @PersonaType varchar(100)
AS
/*
