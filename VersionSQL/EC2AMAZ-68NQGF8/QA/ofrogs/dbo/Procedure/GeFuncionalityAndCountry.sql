/****** Object:  Procedure [dbo].[GeFuncionalityAndCountry]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GeFuncionalityAndCountry] @userId int
