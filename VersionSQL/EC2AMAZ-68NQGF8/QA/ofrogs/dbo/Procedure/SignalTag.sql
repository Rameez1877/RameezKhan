/****** Object:  Procedure [dbo].[SignalTag]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[SignalTag]
	@TagId int
...
*/
	...
	Select @IndustryID  = industryid from industrytag where tagid = @tagId and industryid = 23
