/****** Object:  Procedure [dbo].[PopulateDashboardData_TEST1]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE  PROCEDURE [dbo].[PopulateDashboardData_TEST1]
	 @UserId int 
AS 
BEGIN
SET NOCOUNT ON
	...
	IF NOT EXISTS (SELECT OtherProspectAccount FROM OtherProspect WHERE USERID = @UserId)
	BEGIN
	...
	SELECT COUNT(*) FROM DashboardDataSummary WHERE USERID = @UserId
