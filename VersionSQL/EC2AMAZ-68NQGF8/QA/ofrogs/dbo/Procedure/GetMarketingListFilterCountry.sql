/****** Object:  Procedure [dbo].[GetMarketingListFilterCountry]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetMarketingListFilterCountry] 
@targetPersonaId int,
...
If @Functionality is  null
   ...
   Select Top 10 Location, SUM(NoOfRecords) NoOfPersonLocation
