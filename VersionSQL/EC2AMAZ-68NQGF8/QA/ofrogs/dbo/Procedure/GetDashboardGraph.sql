/****** Object:  Procedure [dbo].[GetDashboardGraph]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[GetDashboardGraph] @UserId int
AS BEGIN
SET NOCOUNT ON;
...
EXEC GetDashboardGraph @UserID --23 -- 31
