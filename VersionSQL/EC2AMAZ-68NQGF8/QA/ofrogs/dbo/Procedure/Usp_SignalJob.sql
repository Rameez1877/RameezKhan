/****** Object:  Procedure [dbo].[Usp_SignalJob]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Usp_SignalJob]
...
BEGIN
	...
	where 
	 RFII.IndustryID in (23, 10, 17, 37,44)	
	--and RS.isactive = 1
...
--Each Signal has its own keyword predefined. For ex: M&A signal can have a keyword 'acquires'
	...
	and I.industryID in (23, 10, 17, 37,44)
	...
	Null,
	CASE WHEN ISNULL(PubDate,'2016-03-31')<='2016-3-31 23:59:59' THEN '2016-Q3'	
	...
	and t.tagtypeid = 1
	--and Org.isactive = 1 
	--and RFII.IndustryId in (23, 10, 17, 37,44)
