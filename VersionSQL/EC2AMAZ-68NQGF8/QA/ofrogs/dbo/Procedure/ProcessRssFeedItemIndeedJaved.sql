/****** Object:  Procedure [dbo].[ProcessRssFeedItemIndeedJaved]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[ProcessRssFeedItemIndeedJaved]
	 @linkedId int
AS
BEGIN
/*
...
*/
	...
	select @Title = CompanyName from IndeedJobPost where id=@linkedId
