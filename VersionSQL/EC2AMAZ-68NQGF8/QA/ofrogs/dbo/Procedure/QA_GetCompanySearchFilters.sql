/****** Object:  Procedure [dbo].[QA_GetCompanySearchFilters]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[QA_GetCompanySearchFilters] @UserId int,@AllFilter BIT = 0
AS BEGIN
SET NOCOUNT ON;
...
EXEC [QA_GetCompanySearchFilters] @UserID,0
