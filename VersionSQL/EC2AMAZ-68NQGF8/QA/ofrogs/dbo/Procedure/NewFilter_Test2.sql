/****** Object:  Procedure [dbo].[NewFilter_Test2]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[NewFilter_Test2]
    @UserId int = 0,
...
BEGIN
    ...
    FROM AppUser
    WHERE Id = @UserId
    Declare @Limit int = IIF(@AppRoleID = 3, 50000, 50000)
