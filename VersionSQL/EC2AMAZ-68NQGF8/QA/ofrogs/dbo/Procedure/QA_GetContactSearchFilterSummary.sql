/****** Object:  Procedure [dbo].[QA_GetContactSearchFilterSummary]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[QA_GetContactSearchFilterSummary] @TargetPersonaId int
/*
