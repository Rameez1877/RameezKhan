/****** Object:  Procedure [dbo].[SearchOrganization_new_2]    Committed by VersionSQL https://www.versionsql.com ******/

--exec SearchOrganization_new 1,'','','125','','','AWS','','',''

Create PROCEDURE [dbo].[SearchOrganization_new_2]
     @UserId int = 0,
