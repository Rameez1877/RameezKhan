/****** Object:  Procedure [dbo].[SearchOrganization_dashboard]    Committed by VersionSQL https://www.versionsql.com ******/

--exec SearchOrganization_new 1,'','','125','','','AWS','','',''
CREATE PROCEDURE [dbo].[SearchOrganization_dashboard]
     @UserId int = 0,
...
AS
/*
exec SearchOrganization_dashboard 159,'','6','13','','','','','','','',0,0
